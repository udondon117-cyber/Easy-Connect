...
// アクセシビリティ（視認性）設定
  ...
  autoMusicDetection: boolean;  // 音楽の自動検知を有効にするか
  translationEnabled: boolean;  // 翻訳機能を有効にするか
  targetLanguage: string;       // 翻訳先言語コード
  overlayOpacity: number;       // オーバーレイの不透明度（0.0〜1.0）
};
...
const DEFAULT_SETTINGS: AccessibilitySettings = {
  ...
  autoMusicDetection: false,
  translationEnabled: false,
  targetLanguage: "en",
  overlayOpacity: 0.15,      // 【ウドナ監督要望】スケルトン（薄い背景）をデフォに
};
